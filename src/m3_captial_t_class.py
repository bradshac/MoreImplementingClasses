...
class CapitalT(object):
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        t1 = CapitalT(self.h_rect.get_center(), self.h_rect.get_lower_right_corner().x - self.h_rect.get_upper_left_corner().x,
                        self.v_rect.get_lower_right_corner().y - self.v_rect.get_upper_left_corner().y,
                        self.h_rect.get_lower_right_corner().y- self.h_rect.get_upper_left_corner().y)
        t1.h_rect.fill_color = self.h_rect.fill_color
        t1.v_rect.fill_color = self.v_rect.fill_color
        t1.h_rect.outline_color = self.h_rect.outline_color
        t1.v_rect.outline_color = self.v_rect.outline_color
        return t1
